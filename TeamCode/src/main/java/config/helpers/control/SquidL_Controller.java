...
public class SquidL_Controller {
  private double kSQ, kD, kL;
  ...
  public SquidL_Controller(double kSQ, double kd, double kL) {
    this(kSQ, kd, kL, 0, 0);
  }
   ...
   */
  public SquidL_Controller(double kSQ, double kd, double kL, double sp, double pv) {
    this.kSQ = kSQ;
    this.kD = kd;
    this.kL = kL;
  ...
  public double calculate(double pv) {
    ...
    // returns u(t)
    return kSQ * Math.copySign(Math.sqrt(Math.abs(errorVal_p)), errorVal_p)
        + kD * errorVal_v
        + kL * Math.signum(errorVal_p);
  }

  public void setSQUIDL(double kSQ, double kd, double kL) {
    this.kSQ = kSQ;
    this.kD = kd;
    this.kL = kL;
  }
