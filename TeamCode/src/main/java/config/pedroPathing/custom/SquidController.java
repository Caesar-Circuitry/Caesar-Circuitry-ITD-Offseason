...
public class SquidController extends PIDFController {
  ...
  /**
   * This can be used to update the PIDF's current position when inputting a current position and a
   * target position to calculate error. This will update the error from the current position to the
